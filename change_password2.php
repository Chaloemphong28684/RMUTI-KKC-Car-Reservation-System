...
if (!isset($_SESSION['email'])) {
    header('Location: index.php'); // หากไม่ได้ล็อกอิน ให้ไปที่หน้าหลัก
    exit();
}
...
$display_name = ($row) ? $row['first_name'] . ' ' . $row['last_name'] : 'ผู้ขอจองรถมหาวิทยาลัย';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['new_password'], $_POST['confirm_new_password'])) {
        ...
        if ($new_password === $confirm_new_password) {
            // อัปเดตรหัสผ่านในตาราง login โดยไม่เข้ารหัส
